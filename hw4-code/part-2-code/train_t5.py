...
def eval_epoch(args, model, dev_loader, gt_sql_pth, model_sql_path, gt_record_path, model_record_path):
    ...
    with torch.no_grad():
        for encoder_input, encoder_mask, decoder_input, decoder_targets, _ in tqdm(dev_loader):
            ...
            # NOTE: The rest of the 'for' loop was primarily suggested & generated by GitHub Copilot 
    ...
    error_rate = len(model_error_msgs) / len(predictions) if len(predictions) > 0 else 0.0
...
def test_inference(args, model, test_loader, model_sql_path, model_record_path):
    ...
    with torch.no_grad():
        for encoder_input, encoder_mask, _, _, _ in tqdm(test_loader):
            ...
            # The rest of the 'for' loop was generated by GitHub Copilot
            generated_ids = model.generate(
                input_ids=encoder_input,
                attention_mask=encoder_mask,
                max_length=128,
